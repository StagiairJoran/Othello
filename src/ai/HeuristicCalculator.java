...
public class HeuristicCalculator {
    public double getHeuristicValue(Bord bord, Kleur kleur) {
        ...
        System.out.println("Coin Heuristic Value = " + coinParityHeuristicValue + ", \nMobility Heuristic Value = " + mobilityHeuristicValue  + ", \nCorner Heuristic Value = " + cornerHeuristicValue  + ", \nStability Heuristic Value = " + stabilityHeuristicValue);
        return coinParityHeuristicValue + mobilityHeuristicValue + cornerHeuristicValue + stabilityHeuristicValue;
    }
